	...
	) 
{
	...
	// Input cubemap
	uint32_t inputNumMipmap = Utility::NumMipMap(IBLConfig::InputCubeSideLength, IBLConfig::InputCubeSideLength);
	...
	CubeFilterType filterType)
{
	uint32_t outputMipMapCount = filterType == CubeFilterType::Diffuse ?
		1u :
		Utility::NumMipMap(IBLConfig::OutputSpecularSideLength, IBLConfig::OutputSpecularSideLength);
